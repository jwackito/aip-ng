...
ips_hist = dict()
for date1 in [(x.strftime('%Y-%m-%d')) for x in pd.date_range(start='2021-11-01', end='2021-12-09')]:
...
plt.plot(pd.date_range(start='2021-11-02', end='2021-12-10'), stats[:,1]*100, label='New IP vs 2021-11-01')
